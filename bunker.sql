...
INSERT INTO `погода` (`дата`, `название`, `температура`, `влажность`, `ветер`) VALUES
('2022-10-02', 'прехолодно', -10, 60, 2),
('2022-10-03', 'холодно', -20, 70, 3),
('2022-10-04', 'мороз', -30, 80, 4);
